...
export const howItWorkData = [
  {
    id: 1,
    title: 'Sign Up',
    description: `Sign up for our grocery store management system by providing your basic information. It's quick, easy, and free!`,
  },
  {
    id: 2,
    title: 'Set Up Your Store',
    description: `Customize and set up your store according to your preferences. Add products, categories, and manage inventory effortlessly.`,
  },
  {
    id: 3,
    title: 'Start Selling',
    description: ` Once your store is set up, you can start selling your products to customers both online and offline. Manage orders, track sales, and grow your business effectively.`,
  },
]
